...
df %>% 
 ...
 hc_xAxis (
           title = list(text = "Date",
            ...
            plotBands = list(
                              list(
                                label = list(text = "<b>Demand = Down <br> Supply = Up </br><b>"),
  ...
  # Sub-title Name
  hc_subtitle(text = '9/May/60 - 15/March/65',
...
```{r}
df1 <- read_csv('C:/Users/Noter/Desktop/Data/OilPrice/Raw Data/OPEC.csv')
...
df1 %>% 
 ...
 hc_xAxis (
  ...
  hc_title(text = 'OPEC Price',
           style = list(fontSize = '25px', fontWeight = 'bold')) %>%
  # Sub-title Name
  hc_subtitle(text = '1/May/60 - 14/March/65',
              style = list(fontSize = '16px')) %>%
  # text credit
  hc_credits(enabled = TRUE, text = '@PersThanachot')
